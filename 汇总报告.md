...
从初始值出发，依次获取其迭代哈希列上的值，寻找周期为i的形似*ρ*的环，**i∈[1,∞)**，其中**H_i=H_2i**。

攻击结果👇<br>
![攻击结果](https://github.com/Star-Leeee/homework-group-120/assets/139939885/101e06ce-00c9-48f5-99cf-483bcf615dd0) <br>
在可接受的时间内实现了最高 ***24bit* collision of SM3**
